...
var wpAjaxUrl='https://www.waggachurchofchrist.org.au/wp-admin/admin-ajax.php';var flBuilderUrl='https://www.waggachurchofchrist.org.au/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://www.waggachurchofchrist.org.au/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://www.waggachurchofchrist.org.au/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{if('load_more'==this.settings.pagination&&this.totalPages==this.currPage){$(this.nodeClass+' .fl-builder-pagination-load-more').remove();}}};})(jQuery);(function($){$(function(){new FLBuilderPostGrid({id:'57dd1bd2cd911',layout:'grid',pagination:'numbers',postSpacing:'60',postWidth:'300',matchHeight:1,isRTL:false});});$(window).on('load',function(){$('.fl-node-57dd1bd2cd911 .fl-post-grid').masonry('reloadItems');});})(jQuery);jQuery(function($){$(function(){$('.fl-node-57e11f1177cb6 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});